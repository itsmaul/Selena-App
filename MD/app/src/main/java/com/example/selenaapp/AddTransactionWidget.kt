...
import com.example.selenaapp.ui.transaction.ChooseMethodTransactionActivity
...
class AddTransactionWidget : AppWidgetProvider() {
    override fun onUpdate(
        ...
        val intent = Intent(context, ChooseMethodTransactionActivity::class.java)
        val pendingIntent = PendingIntent.getActivity(
            context, 0, intent, PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE
        )

        // Pasang PendingIntent ke widget
